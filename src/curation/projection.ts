...
export interface CurationProjection {
  readonly stateKey: string; readonly contentId: string; readonly effectiveOrder: EffectiveOrder; readonly primary: EpisodeRecord; readonly evidence: readonly EpisodeRecord[]; readonly observationId: string; readonly currentId: string; readonly text: string;
}
