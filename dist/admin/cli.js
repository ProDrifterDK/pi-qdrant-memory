...
import { initializeDestination } from "./init.js";
    ...
    return {
        ...
        initialize: config => {
            ...
            if (adminKey === undefined)
                throw new Error("Human Qdrant admin key is required for CLI initialization");
...
async function runCommand(command, args, deps) {
    ...
    if (command === "init") {
        ...
        output(deps, parsed.json, command, result);
    }
